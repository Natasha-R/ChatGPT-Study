...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MaintenanceDroidService maintenanceDroidService, SpaceShipDeckService spaceShipDeckService, TransportSystemService transportSystemService) {
        ...
        connection1 = transportSystemService.addConnection(transportSystem1, spaceShipDeck1, Point.fromString("(1,1)"), spaceShipDeck2, Point.fromString("(0,1)"));
        connection2 = transportSystemService.addConnection(transportSystem1, spaceShipDeck2, Point.fromString("(1,0)"), spaceShipDeck3, Point.fromString("(2,2)"));
        connection3 = transportSystemService.addConnection(transportSystem2, spaceShipDeck3, Point.fromString("(2,2)"), spaceShipDeck2, Point.fromString("(1,0)"));
    }
