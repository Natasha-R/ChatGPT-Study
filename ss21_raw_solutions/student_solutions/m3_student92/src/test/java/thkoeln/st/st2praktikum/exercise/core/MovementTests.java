...
public abstract class MovementTests {
    ...
    protected void createWorld(MaintenanceDroidService service) {
        ...
        connection1 = service.addConnection(transportCategory1, spaceShipDeck1, new Vector2D("(1,1)"), spaceShipDeck2, new Vector2D("(0,1)"));
        connection2 = service.addConnection(transportCategory1, spaceShipDeck2, new Vector2D("(1,0)"), spaceShipDeck3, new Vector2D("(2,2)"));
        connection3 = service.addConnection(transportCategory2, spaceShipDeck3, new Vector2D("(2,2)"), spaceShipDeck2, new Vector2D("(1,0)"));
    }
