...
public abstract class MovementTests {
    ...
    protected void createWorld(MaintenanceDroidService service) {
        ...
        connection1 = service.addConnection(transportTechnology1, spaceShipDeck1, new Point("(1,1)"), spaceShipDeck2, new Point("(0,1)"));
        connection2 = service.addConnection(transportTechnology1, spaceShipDeck2, new Point("(1,0)"), spaceShipDeck3, new Point("(2,2)"));
        connection3 = service.addConnection(transportTechnology2, spaceShipDeck3, new Point("(2,2)"), spaceShipDeck2, new Point("(1,0)"));
    }
