...
public abstract class MovementTests {
    ...
    protected void createWorld(CleaningDeviceService service) {
        ...
        connection1 = service.addConnection(transportTechnology1, space1, new Point("(1,1)"), space2, new Point("(0,1)"));
        connection2 = service.addConnection(transportTechnology1, space2, new Point("(1,0)"), space3, new Point("(2,2)"));
        connection3 = service.addConnection(transportTechnology2, space3, new Point("(2,2)"), space2, new Point("(1,0)"));
    }
