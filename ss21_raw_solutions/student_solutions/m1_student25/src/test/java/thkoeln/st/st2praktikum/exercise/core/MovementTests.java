...
import thkoeln.st.st2praktikum.exercise.services.MaintenanceDroidService;
...
public abstract class MovementTests {
    ...
    protected void createWorld(MaintenanceDroidService service) {
        ...
        service.addObstacle(spaceShipDeck1,"(0,3)-(2,3)");
        service.addObstacle(spaceShipDeck1,"(3,0)-(3,3)");
        service.addObstacle(spaceShipDeck2,"(0,2)-(4,2)");
