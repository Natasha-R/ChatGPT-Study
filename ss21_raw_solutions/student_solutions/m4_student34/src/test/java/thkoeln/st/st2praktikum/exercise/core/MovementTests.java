...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MaintenanceDroidService maintenanceDroidService, SpaceShipDeckService spaceShipDeckService, TransportSystemService transportSystemService) {
        ...
        transportSystem1 = transportSystemService.addTransportSystem("Internal tube");
        transportSystem2 = transportSystemService.addTransportSystem("Lift");

        connection1 = transportSystemService.addConnection(transportSystem1, spaceShipDeck1, Coordinate.fromString("(1,1)"), spaceShipDeck2, Coordinate.fromString("(0,1)"));
        connection2 = transportSystemService.addConnection(transportSystem1, spaceShipDeck2, Coordinate.fromString("(1,0)"), spaceShipDeck3, Coordinate.fromString("(2,2)"));
        connection3 = transportSystemService.addConnection(transportSystem2, spaceShipDeck3, Coordinate.fromString("(2,2)"), spaceShipDeck2, Coordinate.fromString("(1,0)"));
    }
