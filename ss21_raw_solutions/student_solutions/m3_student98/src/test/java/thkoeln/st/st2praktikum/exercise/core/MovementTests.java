...
public abstract class MovementTests {
    ...
    protected void createWorld(TidyUpRobotService service) {
        ...
        connection1 = service.addConnection(transportCategory1, room1, new Vector2D("(1,1)"), room2, new Vector2D("(0,1)"));
        connection2 = service.addConnection(transportCategory1, room2, new Vector2D("(1,0)"), room3, new Vector2D("(2,2)"));
        connection3 = service.addConnection(transportCategory2, room3, new Vector2D("(2,2)"), room2, new Vector2D("(1,0)"));
    }
