...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(TidyUpRobotService tidyUpRobotService, RoomService roomService, TransportTechnologyService transportTechnologyService) {
        ...
        connection1 = transportTechnologyService.addConnection(transportTechnology1, room1, Vector2D.fromString("(1,1)"), room2, Vector2D.fromString("(0,1)"));
        connection2 = transportTechnologyService.addConnection(transportTechnology1, room2, Vector2D.fromString("(1,0)"), room3, Vector2D.fromString("(2,2)"));
        connection3 = transportTechnologyService.addConnection(transportTechnology2, room3, Vector2D.fromString("(2,2)"), room2, Vector2D.fromString("(1,0)"));
    }
