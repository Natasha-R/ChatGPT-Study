...
public class LinearSystemUnitTest {
    ...
    @BeforeEach
    public void setup() {
        this.ls = LinearSystem.getInstance();
    }
    ...
    public void testConstructorShouldThrowExceptionWhenMatrixIsUnderSpecified() {
        ...
        //when
        //then
        Assertions.assertThatThrownBy(() -> LinearSystem.getInstance().solve(matrix))
    ...
    @Test
    public void testSolveShouldReturnZeroSolutionsForInvalidOverspecifiedMatrix() {
        //given
        var matrix = new double[][]{
                {1, 2},
                {2, 2},
