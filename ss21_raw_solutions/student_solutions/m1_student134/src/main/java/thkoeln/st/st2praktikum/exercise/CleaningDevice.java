...
public class CleaningDevice {
    ...
    private void moveNorth(int steps, Space currentSpace){
        int possibleSteps = 0;
        while (possibleSteps < steps && currentSpace.hasNoWall(position.getX(), position.getY() + possibleSteps, "no"))
            possibleSteps++;
    ...
    private void moveEast(int steps, Space currentSpace){
        int possibleSteps = 0;
        while (possibleSteps < steps && currentSpace.hasNoWall(position.getX() + possibleSteps, position.getY(), "ea"))
            possibleSteps++;
    ...
    private void moveSouth(int steps, Space currentSpace){
        int possibleSteps = 0;
        while (possibleSteps < steps && currentSpace.hasNoWall(position.getX(), position.getY() - possibleSteps, "so"))
            possibleSteps++;
        position.setY(position.getY() - possibleSteps);
    }
    ...
    private void moveWest(int steps, Space currentSpace){
        int possibleSteps = 0;
        while (possibleSteps < steps && currentSpace.hasNoWall(position.getX() - possibleSteps, position.getY(), "we"))
            possibleSteps++;
        position.setX(position.getX() - possibleSteps);
    }
