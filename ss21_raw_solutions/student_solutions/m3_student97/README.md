...
[http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_97b7506f-cf9b-4e0e-bd2e-855d9c03bcf4]([http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_97b7506f-cf9b-4e0e-bd2e-855d9c03bcf4])
...
1. Give a specific tidy-up tidyUpRobot a command
1. List all the commands a specific tidy-up tidyUpRobot has received so far
1. Delete the command history of a specific tidy-up tidyUpRobot
1. Get all rooms
1. Create a new room
