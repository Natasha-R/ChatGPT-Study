...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MaintenanceDroidService maintenanceDroidService, SpaceShipDeckService spaceShipDeckService, TransportTechnologyService transportTechnologyService) {
        ...
        connection1 = transportTechnologyService.addConnection(transportTechnology1, spaceShipDeck1, Point.fromString("(1,1)"), spaceShipDeck2, Point.fromString("(0,1)"));
        connection2 = transportTechnologyService.addConnection(transportTechnology1, spaceShipDeck2, Point.fromString("(1,0)"), spaceShipDeck3, Point.fromString("(2,2)"));
        connection3 = transportTechnologyService.addConnection(transportTechnology2, spaceShipDeck3, Point.fromString("(2,2)"), spaceShipDeck2, Point.fromString("(1,0)"));
    }
