...
[http://students.pages.st.archi-lab.io/st2/ss21/m0/tests/st2-praktikum_tests_group_ec05e3a7-6d9a-46bb-8144-b49160558565]([http://students.pages.st.archi-lab.io/st2/ss21/m0/tests/st2-praktikum_tests_group_ec05e3a7-6d9a-46bb-8144-b49160558565])
...
1. The field contains **obstacles**, depicted as red lines. The obstacles run only horizontally or
    ...
    * (3,3)-(5,3)
    * (3,3)-(3,4)
1. In addition, field boundaries cannot be passed - essentially they also are a kind of obstacle.
...
1. If the mining machine meets an obstacle or a field boundary, then it moves only as 
...
This is your personal map of the field. You see the dimensions of it. The mining machine is at (1,6).
