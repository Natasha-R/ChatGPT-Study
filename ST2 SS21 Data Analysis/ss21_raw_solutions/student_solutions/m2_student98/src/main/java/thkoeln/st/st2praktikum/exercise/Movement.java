...
public class Movement implements Moveable {
    ...
    private final Vector2DRoom startingPosition;
    private final Orientation orientation;
    private final Integer requestedStepLength;

    private Vector2DRoom currentPosition;
    private Integer currentStepLength;
    private MovementStatus movementStatus;

    public Movement (Vector2DRoom startingPosition, Orientation orientation, Integer stepLength) {
    ...
    @Override
    public Vector2DRoom takeSingleStep() {
        if (!isStatusMoveable()) {
    ...
    @Override
    public Vector2DRoom nextRequestedPositionFromCurrentPosition() {
    ...
    @Override
    public Vector2DRoom getCurrentPosition() {
        return currentPosition;
    }
    ...
    private Vector2DRoom calculateNewPosition(Vector2DRoom position, Integer stepLength) {
        ...
        return new Vector2DRoom(position.getRoom(), newXPos, newYPos);
    }
}
