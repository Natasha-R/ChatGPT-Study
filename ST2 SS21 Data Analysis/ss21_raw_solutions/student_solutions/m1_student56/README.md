...
[http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_6eb3dd68-a3fb-4fed-aa67-f66c5dd111fd]([http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_6eb3dd68-a3fb-4fed-aa67-f66c5dd111fd])
...
1. There are now multiple tidy-up robots. A tile can contain only one tidy-up robot, therefore tidy-up robots 
    are like barriers for other tidy-up robots.   
1. The tidy-up robots have to learn some new commands - in addition to moving to adjacent tiles, they can now use 
