...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(TidyUpRobotService tidyUpRobotService, RoomService roomService, TransportCategoryService transportCategoryService) {
        ...
        connection1 = transportCategoryService.addConnection(transportCategory1, room1, Point.fromString("(1,1)"), room2, Point.fromString("(0,1)"));
        connection2 = transportCategoryService.addConnection(transportCategory1, room2, Point.fromString("(1,0)"), room3, Point.fromString("(2,2)"));
        connection3 = transportCategoryService.addConnection(transportCategory2, room3, Point.fromString("(2,2)"), room2, Point.fromString("(1,0)"));
    }
