...
public abstract class MovementTests {
    ...
    protected void createWorld(MiningMachineService service) {
        ...
        connection1 = service.addConnection(transportTechnology1, field1, new Point("(1,1)"), field2, new Point("(0,1)"));
        connection2 = service.addConnection(transportTechnology1, field2, new Point("(1,0)"), field3, new Point("(2,2)"));
        connection3 = service.addConnection(transportTechnology2, field3, new Point("(2,2)"), field2, new Point("(1,0)"));
    }
