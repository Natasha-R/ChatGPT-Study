...
public abstract class MovementTests {
    ...
    protected void createWorld(CleaningDeviceService service) {
        ...
        connection1 = service.addConnection(transportCategory1, space1, new Coordinate("(1,1)"), space2, new Coordinate("(0,1)"));
        connection2 = service.addConnection(transportCategory1, space2, new Coordinate("(1,0)"), space3, new Coordinate("(2,2)"));
        connection3 = service.addConnection(transportCategory2, space3, new Coordinate("(2,2)"), space2, new Coordinate("(1,0)"));
    }
