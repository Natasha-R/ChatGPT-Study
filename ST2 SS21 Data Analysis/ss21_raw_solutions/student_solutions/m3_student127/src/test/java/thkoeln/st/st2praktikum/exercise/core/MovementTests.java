...
public abstract class MovementTests {
    ...
    protected void createWorld(TidyUpRobotService service) {
        ...
        connection1 = service.addConnection(transportTechnology1, room1, new Point("(1,1)"), room2, new Point("(0,1)"));
        connection2 = service.addConnection(transportTechnology1, room2, new Point("(1,0)"), room3, new Point("(2,2)"));
        connection3 = service.addConnection(transportTechnology2, room3, new Point("(2,2)"), room2, new Point("(1,0)"));
    }
