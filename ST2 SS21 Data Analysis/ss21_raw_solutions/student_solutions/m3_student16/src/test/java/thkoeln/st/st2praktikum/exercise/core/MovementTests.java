...
public abstract class MovementTests {
    ...
    protected void createWorld(MiningMachineService service) {
        ...
        connection1 = service.addConnection(transportSystem1, field1, new Coordinate("(1,1)"), field2, new Coordinate("(0,1)"));
        connection2 = service.addConnection(transportSystem1, field2, new Coordinate("(1,0)"), field3, new Coordinate("(2,2)"));
        connection3 = service.addConnection(transportSystem2, field3, new Coordinate("(2,2)"), field2, new Coordinate("(1,0)"));
    }
