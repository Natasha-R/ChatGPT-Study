...
public class MaintenanceDroidService {
    ...
    public UUID addConnection(UUID sourceSpaceShipDeckId, Point sourcePoint, UUID destinationSpaceShipDeckId, Point destinationPoint) {
        return deckManager.addConnectionToDeckByUUID(sourceSpaceShipDeckId, sourcePoint, destinationSpaceShipDeckId, destinationPoint);
    ...
    public Boolean executeCommand(UUID maintenanceDroidId, Task task) {
        return droidManager.executeRequestedCommandOnDroid(maintenanceDroidId, task);
    }
    ...
    public Point getPoint(UUID maintenanceDroidId) {
        return this.droidManager.getMaintenanceDroidByUUID(maintenanceDroidId).getPosition();
    }
}
