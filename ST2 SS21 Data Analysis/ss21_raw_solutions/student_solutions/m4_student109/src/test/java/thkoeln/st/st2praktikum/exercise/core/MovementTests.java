...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MaintenanceDroidService maintenanceDroidService, SpaceShipDeckService spaceShipDeckService, TransportSystemService transportSystemService) {
        ...
        connection1 = transportSystemService.addConnection(transportSystem1, spaceShipDeck1, Vector2D.fromString("(1,1)"), spaceShipDeck2, Vector2D.fromString("(0,1)"));
        connection2 = transportSystemService.addConnection(transportSystem1, spaceShipDeck2, Vector2D.fromString("(1,0)"), spaceShipDeck3, Vector2D.fromString("(2,2)"));
        connection3 = transportSystemService.addConnection(transportSystem2, spaceShipDeck3, Vector2D.fromString("(2,2)"), spaceShipDeck2, Vector2D.fromString("(1,0)"));
    }
