...
public class Field extends AbstractEntity implements Grid {
    ...
    public void moveMiningMachine(MiningMachine miningMachine, CommandType direction, int distance) {
        if (!miningMachineMap.containsValue(miningMachine)) {
            throw new ResourceNotFoundException("No Mining Machine with this id on this Field");
        }
