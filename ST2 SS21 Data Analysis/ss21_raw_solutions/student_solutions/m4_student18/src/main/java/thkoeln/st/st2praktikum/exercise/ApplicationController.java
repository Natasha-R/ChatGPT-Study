...
import thkoeln.st.st2praktikum.exercise.tidyuprobot.application.TidyUpRobotRepository;
...
@Service
@NoArgsConstructor
public class ApplicationController implements RobotInterface, OperatorInterface {
    ...
    @Autowired
    public ApplicationController(TidyUpRobotRepository tidyUpRobotRepository, RoomRepository roomRepository, ConnectionRepository connectionRepository, TransportSystemRepository transportSystemRepository) {
