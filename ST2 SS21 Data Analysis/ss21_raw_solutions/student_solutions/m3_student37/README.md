...
[http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_239d58a7-df85-4893-821d-560478e1a27b]([http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_239d58a7-df85-4893-821d-560478e1a27b])
...
1. Give a specific maintenance maintenanceDroid a task
1. List all the tasks a specific maintenance maintenanceDroid has received so far
1. Delete the task history of a specific maintenance maintenanceDroid
...
1. Get all obstacles contained in a specific spaceship deck
1. Delete all obstacles contained in a specific spaceship deck
1. Add a new obstacle to a spaceship deck
1. Delete a obstacle on a spaceship deck
