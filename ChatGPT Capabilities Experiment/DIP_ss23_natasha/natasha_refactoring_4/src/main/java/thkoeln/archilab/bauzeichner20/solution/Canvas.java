...
public class Canvas {
    ...
    @OneToMany
    private List<Drawable> drawingElements = new ArrayList<>();
    ...
    public void addDrawingElement( Drawable drawingElement ) {
    ...
    public List<Drawable> getNeighboursOf( Drawable drawingElement ) {
        ...
        for ( Drawable element : drawingElements ) {
