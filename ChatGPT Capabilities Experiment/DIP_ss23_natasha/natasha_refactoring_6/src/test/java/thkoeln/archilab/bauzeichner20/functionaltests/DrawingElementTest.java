...
public class DrawingElementTest {
    ...
    @BeforeEach
    public void setup() {
        door1 = DrawingElement.door( 100, 0, 120, 210 );
        door2 = DrawingElement.door( 600, 0, 140, 250 );
        window1Bottom = DrawingElement.window( 250, 70, 50, 50 );
        window1Top = DrawingElement.window( 260, 140, 30, 80 );
        window2 = DrawingElement.window( 740, 300, 100, 40 );
    }
    ...
    public void testMoveInvalid() {
        ...
        assertThrows( BauzeichnerException.class, () -> door2.move( TOP, 10 ) );
    }
    ...
    public void testMoveValidWithoutCanvas() {
       ...
       // then
        assertEquals( 180, topEdgeWindow1Top );
