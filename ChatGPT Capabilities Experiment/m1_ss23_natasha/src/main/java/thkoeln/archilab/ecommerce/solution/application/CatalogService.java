...
import thkoeln.archilab.ecommerce.solution.domain.CatalogRepository;
...
public class CatalogService implements ThingCatalogUseCases {
    ...
    @Autowired
    public CatalogService(CatalogRepository catalogRepository, ThingRepository thingRepository, CustomerRepository customerRepository, OrderRepository orderRepository) {
    ...
    public void removeThingFromCatalog(UUID thingId) {
        ...
        boolean isInOrder = StreamSupport.stream(orderRepository.findAll().spliterator(), false)
