...
public class RegressionShoppingBasketTest {
    ...
    public void testCheckout() {
        ...
        int stock2before = THING_STOCK.get( thingId2 );
        ...
        // when
        shoppingBasketUseCases.addThingToShoppingBasket( customerMailAddress3, thingId1, stock1before-2 );
        shoppingBasketUseCases.addThingToShoppingBasket( customerMailAddress3, thingId2, 4 );
        shoppingBasketUseCases.addThingToShoppingBasket( customerMailAddress3, thingId3, 5 );
        shoppingBasketUseCases.checkout( customerMailAddress3 );
        int stock1after = stockManagementUseCases.getAvailableStock( thingId1 );
        int stock2after = stockManagementUseCases.getAvailableStock( thingId2 );
