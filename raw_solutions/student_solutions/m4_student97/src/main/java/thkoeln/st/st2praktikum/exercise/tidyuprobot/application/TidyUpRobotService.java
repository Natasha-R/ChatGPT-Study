...
import thkoeln.st.st2praktikum.exercise.tidyuprobot.domain.movement.TidyUpRobotCommandService;
...
public class TidyUpRobotService {
    ...
    public Boolean executeCommand(UUID tidyUpRobotId, Command command) {
        ...
        TidyUpRobotCommandService tidyUpRobotCommandService = new TidyUpRobotCommandService(tidyUpRobotRepository, roomRepository, transportCategoryService);
        Boolean commandResponse = tidyUpRobotCommandService.processCommand(tidyUpRobot, command);
    ...
    public Point getTidyUpRobotPoint(UUID tidyUpRobotId) {
        return tidyUpRobotRepository.findById(tidyUpRobotId).get().getPoint();
    }
