...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(CleaningDeviceService cleaningDeviceService, SpaceService spaceService, TransportCategoryService transportCategoryService) {
        ...
        connection1 = transportCategoryService.addConnection(transportCategory1, space1, Vector2D.fromString("(1,1)"), space2, Vector2D.fromString("(0,1)"));
        connection2 = transportCategoryService.addConnection(transportCategory1, space2, Vector2D.fromString("(1,0)"), space3, Vector2D.fromString("(2,2)"));
        connection3 = transportCategoryService.addConnection(transportCategory2, space3, Vector2D.fromString("(2,2)"), space2, Vector2D.fromString("(1,0)"));
    }
