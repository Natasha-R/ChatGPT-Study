...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MiningMachineService miningMachineService, FieldService fieldService, TransportSystemService transportSystemService) {
        ...
        connection1 = transportSystemService.addConnection(transportSystem1, field1, Coordinate.fromString("(1,1)"), field2, Coordinate.fromString("(0,1)"));
        connection2 = transportSystemService.addConnection(transportSystem1, field2, Coordinate.fromString("(1,0)"), field3, Coordinate.fromString("(2,2)"));
        connection3 = transportSystemService.addConnection(transportSystem2, field3, Coordinate.fromString("(2,2)"), field2, Coordinate.fromString("(1,0)"));
    }
