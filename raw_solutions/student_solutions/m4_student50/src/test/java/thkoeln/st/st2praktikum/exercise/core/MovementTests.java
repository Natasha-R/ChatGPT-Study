...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(TidyUpRobotService tidyUpRobotService, RoomService roomService, TransportSystemService transportSystemService) {
        ...
        roomService.addWall(room1, Wall.fromString("(0,3)-(2,3)"));
        roomService.addWall(room1, Wall.fromString("(3,0)-(3,3)"));
        roomService.addWall(room2, Wall.fromString("(0,2)-(4,2)"));
        ...
        connection1 = transportSystemService.addConnection(transportSystem1, room1, Coordinate.fromString("(1,1)"), room2, Coordinate.fromString("(0,1)"));
        connection2 = transportSystemService.addConnection(transportSystem1, room2, Coordinate.fromString("(1,0)"), room3, Coordinate.fromString("(2,2)"));
        connection3 = transportSystemService.addConnection(transportSystem2, room3, Coordinate.fromString("(2,2)"), room2, Coordinate.fromString("(1,0)"));
    }
