...
import thkoeln.st.st2praktikum.exercise.room.application.RoomMap;
import thkoeln.st.st2praktikum.exercise.room.domain.Wall;
import thkoeln.st.st2praktikum.exercise.room.domain.WallMap;
import thkoeln.st.st2praktikum.exercise.transporttechnology.application.TraversableConnectionMap;
...
import static thkoeln.st.st2praktikum.exercise.domainprimitives.CommandType.SOUTH;
