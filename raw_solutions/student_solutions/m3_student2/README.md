...
[http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_fa5483f9-faa0-4f52-91f4-740b5f91822f]([http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_fa5483f9-faa0-4f52-91f4-740b5f91822f])
...
1. Give a specific tidy-up robot a command
1. List all the commands a specific tidy-up robot has received so far
1. Delete the command history of a specific tidy-up robot
1. Get all rooms
1. Create a new room
