...
public class E1MovementTests extends MovementTests {
   TidyUpRobotService service;
    ...
    @Test
    public void moveRobotIntoOtherRobotTest() {
    ...
    public void placeConnectionOutOfBoundsTest() {
        ...
        assertThrows(OutOfBoundsException.class, () -> {UUID faultyConnection = service.addConnection(room3, new Vector2D("(4,4)"), room1, new Vector2D("(0,1)"));});

    }

    @Test
    public void transportCommandOnNoConnection() {
