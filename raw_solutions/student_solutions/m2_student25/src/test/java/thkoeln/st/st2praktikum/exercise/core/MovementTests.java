...
public abstract class MovementTests {
    ...
    protected UUID connection4;
    protected UUID connection5;
    ...
    protected void createWorld(MaintenanceDroidService service) {
        ...
        connection4 = service.addConnection(spaceShipDeck3, new Coordinate("(4,2)"), spaceShipDeck2, new Coordinate("(7,0)"));
        connection5 = service.addConnection(spaceShipDeck3, new Coordinate("(2,2)"), spaceShipDeck2, new Coordinate("(0,0)"));
