...
[http://students.pages.st.archi-lab.io/st2/ss21/m0/tests/st2-praktikum_tests_group_592c9380-0710-4430-aa19-d4ad02d62d39]([http://students.pages.st.archi-lab.io/st2/ss21/m0/tests/st2-praktikum_tests_group_592c9380-0710-4430-aa19-d4ad02d62d39])
...
1. The room contains **obstacles**, depicted as red lines. The obstacles run only horizontally or
    ...
    * (3,3)-(5,3)
    * (3,3)-(3,4)
1. In addition, room boundaries cannot be passed - essentially they also are a kind of obstacle.
...
1. If the tidy-up robot meets an obstacle or a room boundary, then it moves only as 
...
This is your personal map of the room. You see the dimensions of it. The tidy-up robot is at (1,7).
