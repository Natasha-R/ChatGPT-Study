...
import thkoeln.st.st2praktikum.exercise.commandExecution.CommandExecution;
...
public class TidyUpRobotService {
    ...
    CommandExecution commandExecution = new CommandExecution(robotMap,roomMap,connectionMap);
    ...
    public UUID addRoom(Integer height, Integer width) {
        return roomMap.addRoom(height,width);
    }
    ...
    public void addObstacle(UUID roomId, String obstacleString) {
        roomMap.addObstacle(roomId,obstacleString);
    }
    ...
    public UUID addConnection(UUID sourceRoomId, String sourceCoordinate, UUID destinationRoomId, String destinationCoordinate) {
        return connectionMap.addConnection(sourceRoomId,sourceCoordinate,destinationRoomId,destinationCoordinate);
    }
    ...
    public UUID addTidyUpRobot(String name) {
        return robotMap.createRobot(name);
    }
    ...
    public Boolean executeCommand(UUID tidyUpRobotId, String commandString) {
        return commandExecution.executeCommand(tidyUpRobotId,commandString);
    }
    ...
    public UUID getTidyUpRobotRoomId(UUID tidyUpRobotId){
        return robotMap.getRoomId(tidyUpRobotId);
    }
    ...
    public String getCoordinates(UUID tidyUpRobotId){
        return robotMap.getRobotById(tidyUpRobotId).getPosition();
    }
}
