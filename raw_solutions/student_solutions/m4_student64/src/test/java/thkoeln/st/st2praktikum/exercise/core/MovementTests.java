...
public abstract class MovementTests extends GenericTests {
    ...
    public void printDebug()
    {
        ...
        System.out.println("-------");
        System.out.println("space1 " + this.space1);
        System.out.println("space2 " + this.space2);
        System.out.println("space3 " + this.space3);
        System.out.println("-------");
        System.out.println("cleaningDevice1 " + this.cleaningDevice1);
        System.out.println("cleaningDevice2 " + this.cleaningDevice2);
        System.out.println("-------");
        System.out.println("connection1 " + this.connection1 + " between " + this.space1 + " and " + this.space2);
        System.out.println("connection2 " + this.connection2);
        System.out.println("connection3 " + this.connection3);
