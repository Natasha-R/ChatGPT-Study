...
import thkoeln.st.st2praktikum.exercise.miningmachine.domain.Findable;
import thkoeln.st.st2praktikum.exercise.miningmachine.domain.MiningMachine;
import thkoeln.st.st2praktikum.exercise.miningmachine.domain.MiningMachineRepository;
import thkoeln.st.st2praktikum.exercise.miningmachine.domain.Moveable;
import thkoeln.st.st2praktikum.exercise.transportcategory.application.Connection;
...
public class MiningMachineCommands implements Moveable, Findable {
    ...
    public void walk(UUID miningMachineId,int steps, int moveX, int moveY, MiningMachineRepository m){
        ...
        MiningMachine save = findMiningMachine(miningMachineId);
        m.save(save);
    }
    ...
    public MiningMachine findMiningMachine(UUID miningMachineId){
        for(int i = 0; i<miningMachines.size(); i++){
            if(miningMachines.get(i).getId().equals(miningMachineId)){
