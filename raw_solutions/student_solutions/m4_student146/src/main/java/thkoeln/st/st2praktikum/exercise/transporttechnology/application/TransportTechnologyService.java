...
import thkoeln.st.st2praktikum.exercise.miningmachine.application.MiningMachineRepository;
...
public class TransportTechnologyService {
    public final TransportTechnologyRepo transportTechnologyRepo;
    ...
    public UUID addConnection(UUID transportTechnologyId,
        ...
        FieldConnection fieldConnection = new FieldConnection(sourceFieldId, sourceCoordinate, destinationFieldId, destinationCoordinate);
