...
public abstract class MovementTests {
    ...
    protected void createWorld(MaintenanceDroidService service) {
        ...
        connection1 = service.addConnection(transportSystem1, spaceShipDeck1, new Coordinate("(1,1)"), spaceShipDeck2, new Coordinate("(0,1)"));
        connection2 = service.addConnection(transportSystem1, spaceShipDeck2, new Coordinate("(1,0)"), spaceShipDeck3, new Coordinate("(2,2)"));
        connection3 = service.addConnection(transportSystem2, spaceShipDeck3, new Coordinate("(2,2)"), spaceShipDeck2, new Coordinate("(1,0)"));
    }
