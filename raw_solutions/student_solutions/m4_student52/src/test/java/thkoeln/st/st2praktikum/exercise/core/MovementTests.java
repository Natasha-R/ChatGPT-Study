...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MiningMachineService miningMachineService, FieldService fieldService, TransportSystemService transportSystemService) {
        field1 = fieldService.addField(6,6);
        field2 = fieldService.addField(5,5);
        field3 = fieldService.addField(3,3);

        fieldService.addBarrier(field1, Barrier.fromString("(0,3)-(2,3)"));
        fieldService.addBarrier(field1, Barrier.fromString("(3,0)-(3,3)"));
        fieldService.addBarrier(field2, Barrier.fromString("(0,2)-(4,2)"));
        ...
        transportSystem1 = transportSystemService.addTransportSystem("Tunnel");
        transportSystem2 = transportSystemService.addTransportSystem("Conveyor belt");

        connection1 = transportSystemService.addConnection(transportSystem1, field1, Point.fromString("(1,1)"), field2, Point.fromString("(0,1)"));
        connection2 = transportSystemService.addConnection(transportSystem1, field2, Point.fromString("(1,0)"), field3, Point.fromString("(2,2)"));
        connection3 = transportSystemService.addConnection(transportSystem2, field3, Point.fromString("(2,2)"), field2, Point.fromString("(1,0)"));
    }
