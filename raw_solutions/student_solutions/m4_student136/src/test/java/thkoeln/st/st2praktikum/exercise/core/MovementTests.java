...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(MiningMachineService miningMachineService, FieldService fieldService, TransportCategoryService transportCategoryService) {
        ...
        connection1 = transportCategoryService.addConnection(transportCategory1, field1, Vector2D.fromString("(1,1)"), field2, Vector2D.fromString("(0,1)"));
        connection2 = transportCategoryService.addConnection(transportCategory1, field2, Vector2D.fromString("(1,0)"), field3, Vector2D.fromString("(2,2)"));
        connection3 = transportCategoryService.addConnection(transportCategory2, field3, Vector2D.fromString("(2,2)"), field2, Vector2D.fromString("(1,0)"));
    }
