...
[http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_b06ba927-fc73-431c-a245-e10f98bee1c6]([http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_b06ba927-fc73-431c-a245-e10f98bee1c6])
...
In Milestone 0, you have successfully taught the maintenance droid to navigate a spaceship deck with walls. Hooray!
...
1. There are now multiple maintenance droids. A cell can contain only one maintenance droid, therefore maintenance droids 
    are like walls for other maintenance droids.   
1. The maintenance droids have to learn some new commands - in addition to moving to adjacent cells, they can now use 
...
1. Initially there are no maintenance droids, no spaceship decks, no walls and no connections - you have to provide an API to create them.
