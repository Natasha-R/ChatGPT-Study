...
public class MaintenanceDroid {
    ...
    public void move(String command) {
        String direction = command.substring(1, 3);
        int steps = Integer.parseInt(command.substring(4, command.length() - 1));
        int newX = currentX;
        int newY = currentY;
        ...
        switch (direction) {
            ...
            case "we":
                ...
                break;
            default:
                System.out.println("Invalid command direction: " + direction);
        }
