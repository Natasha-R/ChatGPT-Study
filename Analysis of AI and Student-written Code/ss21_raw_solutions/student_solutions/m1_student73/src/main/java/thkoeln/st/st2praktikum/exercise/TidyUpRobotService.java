...
public class TidyUpRobotService {
    ...
    public void addBarrier(UUID roomId, String barrierString) {
        worldBuilder.getRoomFinder().get(roomId).addBarrier(barrierString);
    }
    ...
    public UUID addConnection(UUID sourceRoomId, String sourceCoordinate, UUID destinationRoomId, String destinationCoordinate) {
        return worldBuilder.getRoomFinder().get(sourceRoomId).addConnection(sourceCoordinate,destinationRoomId, destinationCoordinate);
    }
    ...
    public Boolean executeCommand(UUID tidyUpRobotId, String commandString) {
        return worldBuilder.getRobotFinder().get(tidyUpRobotId).commandDecider(commandString, worldBuilder.getRoomFinder());
    }
    ...
    public UUID getTidyUpRobotRoomId(UUID tidyUpRobotId){
        return worldBuilder.getRobotFinder().get(tidyUpRobotId).getCurrentRoom();
    }
    ...
    public String getCoordinates(UUID tidyUpRobotId){
        return worldBuilder.getRobotFinder().get(tidyUpRobotId).getCurrentPositionAsString();
    }
}
