...
[http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_a017e658-d6f4-4836-8a3e-861fcfb96088]([http://students.pages.st.archi-lab.io/st2/ss21/m3/tests/st2-praktikum_tests_group_a017e658-d6f4-4836-8a3e-861fcfb96088])
...
1. Give a specific cleaning device an order
1. List all the orders a specific cleaning device has received so far
1. Delete the order history of a specific cleaning device
1. Get all spaces
...
1. Get all barriers contained in a specific space
1. Delete all barriers contained in a specific space
1. Add a new barrier to a space
1. Delete a barrier on a space
