...
public class Exercise0 implements GoAble {
    ...
    private static final int Y_AXE = 8;
    private static final int X_AXE = 11;
...
//            System.out.println(power);
            ...
            // -> Border yes no
            if(this.borderCheck(direction, position)) {
    ...
    private boolean borderCheck(String direction, String[] position) {
        ...
        switch (direction) {
            case "no":
                if(Integer.parseInt(position[1])+1 == Y_AXE){
                    result = true;
                }
                break;
            case "ea":
                if(Integer.parseInt(position[0])+1 == X_AXE){
                    result = true;
                }
                break;
            case "so":
...
//                System.out.println(maybeBorderEnd);
                result = this.borderSearch(maybeBorderStart, maybeBorderEnd);
                break;
            case "ea":
