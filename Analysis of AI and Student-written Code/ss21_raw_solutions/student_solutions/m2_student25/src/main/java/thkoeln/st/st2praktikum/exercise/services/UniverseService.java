...
public interface UniverseService {
    static Boolean isStepCommand(CommandInterface command, MaintenanceDroidInterface maintenanceDroid, UniverseInterface universe) throws MaintenanceDroidPositionIsNull, SquareNotFoundException, IllegalArgumentException {
        for (int i = 0; i < command.getSteps(); i++) {
            ...
            MyCoordinateInterface coordinateMaintenanceDroid = StringService.translateCoordinateToMyCoordinate(universe.getCoordinates(maintenanceDroid.getMaintenanceDroidID()));
            ObstacleInterface tmpMyObstacle;
            switch (command.getDirection()) {
                case NO:
                    if (coordinateMaintenanceDroid.getY() + 1 == tmpSpaceShipDeck.getHeight()) break;
                    tmpMyObstacle = new MyObstacle(new Obstacle(new Coordinate(coordinateMaintenanceDroid.getX(), coordinateMaintenanceDroid.getY() + 1), new Coordinate(coordinateMaintenanceDroid.getX() + 1, coordinateMaintenanceDroid.getY() + 1)));
                    if (!ObstacleService.contains(tmpSpaceShipDeck.getAllObstacles(), tmpMyObstacle) || universe.isSquareOccupied(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID(), maintenanceDroid.getMaintenanceDroidID(), tmpSpaceShipDeck)) {
                ...
                case EA:
                    ...
                    tmpMyObstacle = new MyObstacle(new Obstacle(new Coordinate(coordinateMaintenanceDroid.getX() + 1, coordinateMaintenanceDroid.getY()), new Coordinate(coordinateMaintenanceDroid.getX() + 1, coordinateMaintenanceDroid.getY() + 1)));
                    if (!ObstacleService.contains(tmpSpaceShipDeck.getAllObstacles(), tmpMyObstacle) || universe.isSquareOccupied(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID(), maintenanceDroid.getMaintenanceDroidID(), tmpSpaceShipDeck)) {
                        universe.getMaintenanceDroidHashMap().get(maintenanceDroid.getMaintenanceDroidID()).getMaintenanceDroidPosition().setSquareID(tmpSpaceShipDeck.getNextSquareUUIDinDirection(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID()));
                    }
                    break;
                case SO:
                    ...
                    tmpMyObstacle = new MyObstacle(new Obstacle(new Coordinate(coordinateMaintenanceDroid.getX(), coordinateMaintenanceDroid.getY()), new Coordinate(coordinateMaintenanceDroid.getX() + 1, coordinateMaintenanceDroid.getY())));
                    if (!ObstacleService.contains(tmpSpaceShipDeck.getAllObstacles(), tmpMyObstacle) || universe.isSquareOccupied(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID(), maintenanceDroid.getMaintenanceDroidID(), tmpSpaceShipDeck)) {
                        universe.getMaintenanceDroidHashMap().get(maintenanceDroid.getMaintenanceDroidID()).getMaintenanceDroidPosition().setSquareID(tmpSpaceShipDeck.getNextSquareUUIDinDirection(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID()));
                    }
                    break;
                case WE:
                    ...
                    tmpMyObstacle = new MyObstacle(new Obstacle(new Coordinate(coordinateMaintenanceDroid.getX(), coordinateMaintenanceDroid.getY()), new Coordinate(coordinateMaintenanceDroid.getX(), coordinateMaintenanceDroid.getY() + 1)));
                    if (!ObstacleService.contains(tmpSpaceShipDeck.getAllObstacles(), tmpMyObstacle) || universe.isSquareOccupied(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID(), maintenanceDroid.getMaintenanceDroidID(), tmpSpaceShipDeck)) {
                        universe.getMaintenanceDroidHashMap().get(maintenanceDroid.getMaintenanceDroidID()).getMaintenanceDroidPosition().setSquareID(tmpSpaceShipDeck.getNextSquareUUIDinDirection(command.getDirection(), maintenanceDroid.getMaintenanceDroidPosition().getSquareID()));
                    }
                    break;
    ...
    static Boolean isUUIDCommand(CommandInterface command, MaintenanceDroidInterface maintenanceDroid, UniverseInterface universe) throws MaintenanceDroidPositionIsNull, SquareNotFoundException, IllegalArgumentException, IllegalStateException {
        switch (command.getDirection()) {
            case TR:
                ...
                break;
            case EN:
                UUID tmpSquareID = universe.getSpaceShipDeckHashMap().get(command.getSpaceShipDeckUUUID()).findSquareAt(new MyCoordinate(new Coordinate(0, 0))).getSquareID();
