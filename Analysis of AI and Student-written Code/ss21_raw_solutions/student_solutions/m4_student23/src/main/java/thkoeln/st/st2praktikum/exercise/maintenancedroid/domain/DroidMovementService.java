...
import static thkoeln.st.st2praktikum.exercise.domainprimitives.TaskType.*;
...
public class DroidMovementService {
    ...
    public DroidMovementService(SpaceShipDeckRepository shipDeckRepository) {
        this.shipDeckRepository = shipDeckRepository;
    }

    public Boolean moveDroid(MaintenanceDroid droid, Task task, Boolean verboseOutput) {
    ...
    private SpaceShipDeck getCurrentDeckForDroid(MaintenanceDroid droid) {
        return this.shipDeckRepository.getSpaceShipDeckByUUID(droid.getSpaceShipDeckId());
    }
