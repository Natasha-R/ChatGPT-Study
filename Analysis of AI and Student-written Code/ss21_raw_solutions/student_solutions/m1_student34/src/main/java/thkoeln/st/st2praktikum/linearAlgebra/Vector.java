...
public class Vector {
    ...
    public static Vector of(String input) {
        if (!input.startsWith("(") || !input.endsWith(")")) {
            throw new IllegalArgumentException(input + " has to start and end" +
                    " with parenthesis");
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Comma is missing: " + input, e);
        }
    }
