...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(CleaningDeviceService cleaningDeviceService, SpaceService spaceService, TransportTechnologyService transportTechnologyService) {
        ...
        connection1 = transportTechnologyService.addConnection(transportTechnology1, space1, Point.fromString("(1,1)"), space2, Point.fromString("(0,1)"));
        connection2 = transportTechnologyService.addConnection(transportTechnology1, space2, Point.fromString("(1,0)"), space3, Point.fromString("(2,2)"));
        connection3 = transportTechnologyService.addConnection(transportTechnology2, space3, Point.fromString("(2,2)"), space2, Point.fromString("(1,0)"));
    }
