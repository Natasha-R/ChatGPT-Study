...
import thkoeln.st.st2praktikum.exercise.controllingentity.GlobalMap;
...
public class MiningMachineService {
    ...
    public UUID addField(Integer height, Integer width) {
        return globalMap.createField(Math.abs(height),Math.abs(width));
    }
    ...
    public void addWall(UUID fieldId, String wallString) {
        globalMap.initiateCreationAndPlacementOfWall(globalMap.translateCoordinateFromStringToArrayOfCoordinatePair(wallString),fieldId);
    ...
    public UUID addConnection(UUID sourceFieldId, String sourceCoordinate, UUID destinationFieldId, String destinationCoordinate) {
        return globalMap.initiateCreationOfConnection(sourceFieldId, sourceCoordinate, destinationFieldId, destinationCoordinate);
    ...
    public UUID addMiningMachine(String name) {
        return globalMap.creationOfMachine(name);
    }
    ...
    public Boolean executeCommand(UUID miningMachineId, String commandString) {
        return globalMap.identifyComand(globalMap.translateCommandstring(commandString),miningMachineId);
    ...
    public UUID getMiningMachineFieldId(UUID miningMachineId){
        return globalMap.getMiningMachineByID(miningMachineId).getIsAtFieldId();
    }
    ...
    public String getCoordinates(UUID miningMachineId){
        CoordinatePair coordinate=globalMap.getMiningMachineByID(miningMachineId).getCoordinate();
