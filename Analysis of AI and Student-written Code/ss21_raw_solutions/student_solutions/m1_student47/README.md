...
[http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_22cfc9f0-a410-4775-95af-3e1abc37fa7f]([http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_22cfc9f0-a410-4775-95af-3e1abc37fa7f])
...
1. There are now multiple mining machines. A cell can contain only one mining machine, therefore mining machines 
    are like barriers for other mining machines.   
1. The mining machines have to learn some new commands - in addition to moving to adjacent cells, they can now use 
