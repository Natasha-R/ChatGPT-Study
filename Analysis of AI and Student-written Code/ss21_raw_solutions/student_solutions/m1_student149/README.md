...
[http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_6e064273-2017-4bbc-8477-80199bd6d859]([http://students.pages.st.archi-lab.io/st2/ss21/m1/tests/st2-praktikum_tests_group_6e064273-2017-4bbc-8477-80199bd6d859])
...
In Milestone 0, you have successfully taught the cleaning device to navigate a space with barriers. Hooray!
...
1. There are now multiple cleaning devices. A square can contain only one cleaning device, therefore cleaning devices 
    are like barriers for other cleaning devices.   
1. The cleaning devices have to learn some new commands - in addition to moving to adjacent squares, they can now use 
...
1. Initially there are no cleaning devices, no spaces, no barriers and no connections - you have to provide an API to create them.
