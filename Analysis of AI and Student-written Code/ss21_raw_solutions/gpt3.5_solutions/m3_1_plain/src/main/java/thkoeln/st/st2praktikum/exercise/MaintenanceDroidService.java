...
public class MaintenanceDroidService {
    ...
    public UUID addConnection(UUID sourceSpaceShipDeckId, String sourceCoordinate, UUID destinationSpaceShipDeckId, String destinationCoordinate, String transportCategory) {
        ...
        Connection connection = new Connection(connectionId, sourceSpaceShipDeckId, sourceCoordinate, destinationSpaceShipDeckId, destinationCoordinate, transportCategory);
    ...
    public MaintenanceDroid findMaintenanceDroidById(Long id) {
